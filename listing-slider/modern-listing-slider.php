...
//if (!empty($ah_custom_image_slider_1)) {
 // Contains the entire slider. If First Slide isn't published, slider won't replace original.
 
 function listing_slider_shortcode() {
  include_once('meta-box-value/meta-box-value.php');
		?>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_1; ?>" alt="<?php echo $ah_custom_image_slider_1_alt; ?>" />
      ...
      <!--========= #2 Second Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_2; ?>" alt="<?php echo $ah_custom_image_slider_2_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #3 Third Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_3; ?>" alt="<?php echo $ah_custom_image_slider_3_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #4 Fourth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_4; ?>" alt="<?php echo $ah_custom_image_slider_4_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #5 Fifth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_5; ?>" alt="<?php echo $ah_custom_image_slider_4_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #6 Sixth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_6; ?>" alt="<?php echo $ah_custom_image_slider_6_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #7 Seventh Slide =========-->
      <div class="item">
         <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_7; ?>" alt="<?php echo $ah_custom_image_slider_7_alt; ?>" />
         <div class="carousel-caption">
      ...
      <!--========= #8 Eighth Slide =========-->
      <div class="item">
         <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_8; ?>" alt="<?php echo $ah_custom_image_slider_8_alt; ?>" />
         <div class="carousel-caption">
      ...
      <!--========= #9 Ninth Slide =========-->
      <div class="item">
         <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_9; ?>" alt="<?php echo $ah_custom_image_slider_9_alt; ?>" />
         <div class="carousel-caption">
      ...
      <!--========= #10 Tenth Slide =========-->
      <div class="item">
         <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_10; ?>" alt="<?php echo $ah_custom_image_slider_10_alt; ?>" />
         <div class="carousel-caption">
     ...
     <?php } if (!empty(  $ah_custom_image_slider_11 )) { ?>
      ...
      <!--========= #11 Eleventh Slide =========-->
      <div class="item">
       <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_11; ?>" alt="<?php echo $ah_custom_image_slider_11_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #12 Twelfth Slide =========-->
      <div class="item">
         <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_12; ?>" alt="<?php echo $ah_custom_image_slider_12_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #13 Thirteenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_13; ?>" alt="<?php echo $ah_custom_image_slider_13_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #14 Fourteenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_14; ?>" alt="<?php echo $ah_custom_image_slider_14_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #15 Fiftenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_15; ?>" alt="<?php echo $ah_custom_image_slider_15_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #16 Sixteenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_16; ?>" alt="<?php echo $ah_custom_image_slider_16_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_17; ?>" alt="<?php echo $ah_custom_image_slider_17_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #18 Eighteenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_18; ?>" alt="<?php echo $ah_custom_image_slider_18_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #19 Nineteenth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_19; ?>" alt="<?php echo $ah_custom_image_slider_19_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #20 Twentyth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_20; ?>" alt="<?php echo $ah_custom_image_slider_20_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_21; ?>" alt="<?php echo $ah_custom_image_slider_21_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_22; ?>" alt="<?php echo $ah_custom_image_slider_22_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_23; ?>" alt="<?php echo $ah_custom_image_slider_23_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_24; ?>" alt="<?php echo $ah_custom_image_slider_24_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_25; ?>" alt="<?php echo $ah_custom_image_slider_25_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #26 Twentysix Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_26; ?>" alt="<?php echo $ah_custom_image_slider_26_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_27; ?>" alt="<?php echo $ah_custom_image_slider_27_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_28; ?>" alt="<?php echo $ah_custom_image_slider_28_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #29 Twentynine Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_29; ?>" alt="<?php echo $ah_custom_image_slider_29_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #30 Thirtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_30; ?>" alt="<?php echo $ah_custom_image_slider_30_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_31; ?>" alt="<?php echo $ah_custom_image_slider_31_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_32; ?>" alt="<?php echo $ah_custom_image_slider_32_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_33; ?>" alt="<?php echo $ah_custom_image_slider_33_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_34; ?>" alt="<?php echo $ah_custom_image_slider_34_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_35; ?>" alt="<?php echo $ah_custom_image_slider_35_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_36; ?>" alt="<?php echo $ah_custom_image_slider_36_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_37; ?>" alt="<?php echo $ah_custom_image_slider_37_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_38; ?>" alt="<?php echo $ah_custom_image_slider_38_alt; ?>" />
        <div class="carousel-caption">
      ...
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_39; ?>" alt="<?php echo $ah_custom_image_slider_39_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #40 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_40; ?>" alt="<?php echo $ah_custom_image_slider_40_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #41 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_41; ?>" alt="<?php echo $ah_custom_image_slider_41_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #42 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_42; ?>" alt="<?php echo $ah_custom_image_slider_42_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #43 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_43; ?>" alt="<?php echo $ah_custom_image_slider_43_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #44 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_44; ?>" alt="<?php echo $ah_custom_image_slider_44_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #45 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_45; ?>" alt="<?php echo $ah_custom_image_slider_45_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #46 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_46; ?>" alt="<?php echo $ah_custom_image_slider_46_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #47 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_47; ?>" alt="<?php echo $ah_custom_image_slider_47_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #48 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_48; ?>" alt="<?php echo $ah_custom_image_slider_48_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #49 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_49; ?>" alt="<?php echo $ah_custom_image_slider_49_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #50 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_50; ?>" alt="<?php echo $ah_custom_image_slider_50_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #51 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_51; ?>" alt="<?php echo $ah_custom_image_slider_51_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #52 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_52; ?>" alt="<?php echo $ah_custom_image_slider_52_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #53 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_53; ?>" alt="<?php echo $ah_custom_image_slider_53_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #54 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_54; ?>" alt="<?php echo $ah_custom_image_slider_54_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #55 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_55; ?>" alt="<?php echo $ah_custom_image_slider_55_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #56 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_56; ?>" alt="<?php echo $ah_custom_image_slider_56_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #57 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_57; ?>" alt="<?php echo $ah_custom_image_slider_57_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #58 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_58; ?>" alt="<?php echo $ah_custom_image_slider_58_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #59 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_59; ?>" alt="<?php echo $ah_custom_image_slider_59_alt; ?>" />
        <div class="carousel-caption">
      ...
      <!--========= #60 Fourtieth Slide =========-->
      <div class="item">
        <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_60; ?>" alt="<?php echo $ah_custom_image_slider_60_alt; ?>" />
        <div class="carousel-caption">
     ...
     <?php } if (!empty( $ah_custom_image_slider_3 )) { ?>
      ...
      <?php } if (!empty( $ah_custom_image_slider_5 )) { ?>
        ...
        <div class="col-xs-4 col-sm-2 col-md-2 range_slides_item_image" data-target="#thumbnail_image_carousel" data-slide-to="4">
          <a href="#">
            <img class="custom-slider-image" src="<?php echo $ah_custom_image_slider_5; ?>" alt="<?php echo $ah_custom_image_slider_5_alt; ?>" />
          <div class="thumbnailcarousel carousel-caption">
            <p class="slide-number">5</p>
          </div>
          </a>
